    ...
    return (
        <div className='md:m-2 md:flex justify-center bg-white  gap-4'>
            ...
            <div className='bg-slate-400 md:mt-8  rounded-lg flex flex-col md:mt- md:pt-4 pt-6 w-full    md:w-1/3 self-center'>
                ...
                <div className='bg-slate-300 text-black p-6 rounded-tl-3xl  rounded-tr-3xl flex flex-col'>
            ...
            <div className='flex  justify-center flex-col '>
                <h1 className='text-black self-center font-semibold'>Married?? Get Divorce First </h1>
